  ...
  <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center">
    ...
    <div>
      <nav className="relative z-0 inline-flex shadow-sm -space-x-px " aria-label="Pagination">
        ...
        <a href="#" className="hover:bg-blue-800 relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium hover:text-white text-gray-700 hover:bg-gray-50">
          1
        </a>
        <a href="#" className="hover:bg-blue-800 relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium hover:text-white text-gray-700 hover:bg-gray-50">
          2
